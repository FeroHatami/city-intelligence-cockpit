...
RULES = {
    "pharmacy": {
        ...
        "angle": "Operations workflow audit for inventory, procurement, and supplier coordination.",
    ...
    "law_firm": {
        ...
        "angle": "Non-confidential workflow review for intake, document status, and admin follow-up.",
    ...
    "consultant": {
        ...
        "angle": "Proposal, research, and client-reporting workflow improvement.",
    ...
    "real_estate": {
        ...
        "angle": "Listing inquiry, document packet, and follow-up workflow cleanup.",
    ...
    "insurance": {
        ...
        "angle": "Renewal reminder, document collection, and customer follow-up workflow review.",
    ...
    "government": {
        ...
        "angle": "Public-service form and document workflow discovery through official channels.",
    ...
    "company_office": {
        ...
        "angle": "Admin, sales operations, and document workflow review.",
    ...
    "office_building": {
        ...
        "angle": "Operator or tenant qualification before business workflow outreach.",
    ...
    "office": {
        ...
        "angle": "Admin automation, document workflow, and sales operations qualification.",
    ...
    "clinic": {
        ...
        "angle": "Non-clinical appointment, communication, and procurement workflow review.",
    ...
    "coworking": {
        ...
        "angle": "Founder community, member benefit, and event partnership.",
    ...
    "restaurant": {
        ...
        "angle": "Local marketing, reservations, reviews, and inventory quick audit.",
    ...
    "default": {
        ...
        "angle": "Manual qualification for practical workflow improvement fit.",
